...
export function RankingsView({ leaders, uuidMap }: { leaders: Leader[]; uuidMap: UUIDMap }) {
  return (
...
function PlayerCard({ player, rank, uuidMap }: { player: Leader; rank: number; uuidMap: UUIDMap }) {
